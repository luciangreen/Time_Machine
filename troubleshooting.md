...
* Change "GitHub" to the new name of the GitHub folder in `cat_arg_files.pl` and `cat_alg_files.pl`.
* Try running `chmod 777 *.sh` where `*.sh` is the name of a Shell script that won't run.
