...
* The alternative to the Big Meditation 1 Script is (where 108 utterances or 16,000 breasonings in each of the following should contain at least 3 utterances or breasonings before the rest are indicated) 108 arems, 108 friendlinesses, 16,000 breasonings, 108 arems and 108 friendlinesses for each step in (15 by 16k breasonings for an apartment in the time/body systems, body replacement, meditation, time travel, meditation) in the (present and 1-16/10/5698 in the future) followed by body replacement each day.
